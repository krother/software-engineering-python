...
We find working with pylint very rewarding. You can start immediately to fix issues, re-run pylint and see your score improve. Don't try to push every Python file to a score of 10.0. It is OK to ignore warning messages you don't agree with. Use your reason.
